...
############## 集合内置方法 #############
'''
'''1,add() 为集合添加元素  set.add(elmnt)   elmnt -- 必需，要添加的元素。'''
...
'''2,clear()	移除集合中的所有元素  set.clear() 参数无，返回值无'''

'''3,copy()	拷贝一个集合  set.copy()  参数无，返回值无'''
...
'''6,discard()	   删除集合中指定的元素   set.discard(value)  value -- 必需，要移除的元素'''
fruits = {"apple", "banana", "cherry"}
...
'''13,remove()	移除指定元素  set.remove(item)'''
fruits = {"apple", "banana", "cherry"}
fruits.remove("banana")
print(fruits)
# {'cherry', 'apple'}

'''14,symmetric_difference()	返回两个集合中不重复的元素集合。set.symmetric_difference(set)'''
x = {"apple", "banana", "cherry"}
y = {"google", "runoob", "apple"}
